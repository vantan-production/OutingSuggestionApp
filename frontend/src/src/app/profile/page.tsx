  ...
  return (
    <div className="bg-beige w-full h-screen">
      <section className="flex items-center justify-center w-full h-50">
        {/* 仮のheader */}
        <img
          src="/images/takamiuta.png"
          alt="app-logo"
          className="w-53 h-32 object-fill"
        />
      </section>
      <section className="flex items-center justify-between w-73 h-13">
        ...
        <button
          onClick={() => router.back()}
          className="w-11 y-11 flex items-center justify-center"
        >
          <svg
      ...
      <section className="">
        ...
        <div className="p-2">
          ...
          <div className="w-full flex justify-end mt-2">
            <button className="w-20 h-10 rounded-1 bg-blue text-white p">
              変更する
            </button>
          </div>
        </div>
      ...
      <section className="my-4 w-full flex justify-center">
        <button
          onClick={Logout}
          className="w-93 h-13  bg-blue rounded-3 px-4 flex justify-center items-center"
        >
