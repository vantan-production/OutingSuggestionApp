                ...
                <a href="/top" className="border border-black w-32 h-10">
                    ...
                    <div className='flex gap-2.5 justify-center items-center'>
                        ...
                        {isModalOpen && <Modal onClose={handleCloseModal} />}
                            <button className='w-11 y-11'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none" onClick={handleOpenModal}>
                        ...
                        {/* お気に入りアイコン */}
                        {isModalOpen && <Modal onClose={handleCloseModal} />}
                            <button className='w-11 y-11' onClick={handleOpenModal}>
